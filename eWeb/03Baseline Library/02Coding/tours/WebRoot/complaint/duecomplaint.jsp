...
<body class="login" mycollectionplug="bind">
	<div class="login_m">
		...
		<div class="login_boder">
			<s:form action="changecomplaint" method="post"
							theme="simple">
			<div class="login_padding" id="login_model">


				<label>编号<input type="text" name="complaintid"
					class="txt_input txt_input2"  value="<%=username %>"  /></label> 
					<label>时间<input
					type="text" name="time" class="txt_input txt_input2" value=<%=time%> disabled="disabled" /></label> 
					<label>电话<input
					type="text" name="phone" class="txt_input txt_input2" value=<%=phone%> disabled="disabled" /></label>
				<label>处理时间<input type="text" value="2015-09-24 13:59:59"  name="dealtime" class="txt_input txt_input2" /></label>
				  <label>回复<input type="text"  name="answer" class="txt_input txt_input2" /></label> 

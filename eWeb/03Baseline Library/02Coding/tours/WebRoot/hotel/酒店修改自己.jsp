...
<body class="login" mycollectionplug="bind">
	<div class="login_m">
		...
		<div class="login_boder">
			<s:form action="changemy" method="post"
							theme="simple">
			<div class="login_padding" id="login_model">
				...
				<label><input type="hidden" name="h.id"
					...
					<label>密码<input
					type="text" name="passwd" class="txt_input txt_input2" /></label> 
					<label>酒店名字<input
					type="text" name="name" class="txt_input txt_input2" "/></label>
					
				<label>酒店地址<input type="text"   name="address" class="txt_input txt_input2" /></label> 

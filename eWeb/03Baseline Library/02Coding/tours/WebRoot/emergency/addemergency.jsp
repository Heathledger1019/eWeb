...
<title>My JSP '管理员添加旅游.jsp' starting page</title>
...
<body class="login" mycollectionplug="bind">
	<div class="login_m">
		...
		<div class="login_boder">
			<s:form action="addemergency" method="post"
							theme="simple">
			<div class="login_padding" id="login_model">


				<label>标题<input type="text" name="e.title"
					class="txt_input txt_input2" /></label> <label>应急信息号<input
					type="text" name="e.id3" class="txt_input txt_input2" /></label> <label>管理员号<input
					type="text" name="a.id2" class="txt_input txt_input2" /></label>

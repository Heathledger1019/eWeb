...
public class AdministratorDAO {
	...
	public Administrator findById(java.lang.Integer id) {
		...
		try {
			Administrator instance = (Administrator) getCurrentSession().get("Entity.Administrator", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Administrator instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("Entity.Administrator").add(Example.create(instance))
					.list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Administrator instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Administrator as model where model." + propertyName + "= ?";
	...
	public Administrator merge(Administrator detachedInstance) {
		...
		try {
			Administrator result = (Administrator) getCurrentSession().merge(detachedInstance);
	...
	public static AdministratorDAO getFromApplicationContext(ApplicationContext ctx) {

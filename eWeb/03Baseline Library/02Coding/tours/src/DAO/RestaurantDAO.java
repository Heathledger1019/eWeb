...
public class RestaurantDAO {
	...
	public static final String _RMORE = "RMore";
	public static final String _RCOST = "RCost";
	...
	public Restaurant findById(java.lang.String id) {
		log.debug("getting Restaurant instance with id: " + id);
		try {
			Restaurant instance = (Restaurant) getCurrentSession().get("Entity.Restaurant", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Restaurant instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("Entity.Restaurant").add(Example.create(instance))
					.list();
	...
	public List findByRMore(Object RMore) {
		return findByProperty(_RMORE, RMore);
	}

	public List findByRCost(Object RCost) {
		return findByProperty(_RCOST, RCost);
	}

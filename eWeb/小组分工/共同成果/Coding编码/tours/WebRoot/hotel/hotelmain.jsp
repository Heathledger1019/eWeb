			...
			<ul class="nav navbar-nav">
				<li class="myjsp"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li><a href="hotel/hotelchengemyself.jsp?name=<s:property value="h.id" />">修改账号信息  </a></li>
						<li class="divider"></li>
						<li><a href="hotel/hotellogin.jsp">退出</a></li>
					</ul></li>
				<li class="toushu"><a href="hotel/hotelroom.jsp?name=<s:property value="h.id" />">设置酒店剩余房间</a></li>
				<li class="chakan">
				<li><a href="hotel/hotelprice.jsp?name=<s:property value="h.id" />">设置酒店房间价格</a></li>
		</div>
	</div>
	</nav>
